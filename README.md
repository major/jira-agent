...
| Issue composites | `issue start-work`, `issue close`, `issue create-and-assign`, `issue create-and-link`, `issue move-to-sprint` | [`skills/jira-agent/issues.md`](./skills/jira-agent/issues.md) |
