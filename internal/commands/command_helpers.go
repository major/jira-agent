...
func commandCategoryForPath(path string) string {
	...
	if strings.HasPrefix(path, "field") || strings.HasPrefix(path, "project") || strings.HasPrefix(path, "board") || strings.HasPrefix(path, "role") || strings.HasPrefix(path, "priority") || strings.HasPrefix(path, "resolution") || strings.HasPrefix(path, "issuetype") || strings.HasPrefix(path, "label") || strings.HasPrefix(path, "jql") || strings.HasPrefix(path, "resolve") {
